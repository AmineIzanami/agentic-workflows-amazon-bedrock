...
class FrontendStack(Stack):
    ...
    def __init__(self, scope: Construct,
        ...
        imageAsset = DockerImageAsset(self, "FrontendStreamlitImage",
                                      directory=("./streamlit-application/")
                                      )
        ...
        elbv2.ApplicationListenerRule(self, "MyApplicationListenerRule",
                                      ...
                                      priority=1,
                                      conditions=[elbv2.ListenerCondition.http_header(custom_header_name,
                                                                                      [custom_header_value])],
        ...
        elbv2.ApplicationListenerRule(self, "RedirectApplicationListenerRule",
                                      ...
                                      action=elbv2.ListenerAction.redirect(host=cloudfront_distribution.domain_name,
                                                                           permanent=True, protocol="HTTPS", port="443")
                                      )
